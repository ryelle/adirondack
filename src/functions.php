...
function adirondack_scripts() {
	...
	wp_enqueue_script( 'adirondack-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true );
	...
	if ( is_singular() ){
		wp_enqueue_script( 'adirondack-comments', get_template_directory_uri() . '/js/toggle-comments.js', array('jquery'), '20120206', true );
	}
